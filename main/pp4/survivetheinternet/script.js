...
`,
    GC = oi.extend({
        defaults: {
            ...
            error: "",
            strings: {
                ERROR_NOTHING_ENTERED: "Нужно что-то нарисовать!",
...
const HC = `<div id="controller" class="state-controller controller-content">
    ...
    UC = oi.extend({
        defaults: {
            ...
            strings: {
                wait: "Чиллуй!",
                vip_waiting: "Ожидаем других котлетных...",
                vip_canStart: "Нажми эту кнопку, когда все в здании",
                vip_cancel: "Нажми эту кнопку, чтобы пойти нахуй",
                vip_postgame: "Вилкой в глаз или...",
...
`,
    ...
    $s = {
        en: {
            ...
            LANGUAGE: "Язык",
            LOGIN: "Логин",
            STRING_ERROR_SERVER_ROOM_DISCONNECTED: "Пока",
        ...
        ru: {
            ...
            LANGUAGE: "Язык",
            LOGIN: "Логин",
            STRING_ERROR_SERVER_ROOM_DISCONNECTED: "Конец",
            STRING_ERROR_SERVER_ROOM_DESTROYED: "Игра всё! Спасибо за игру в мод!"
        }
    },
